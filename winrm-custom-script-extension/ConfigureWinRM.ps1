...
function Configure-WinRMHttpsListener
{
    ...
    if(-not $thumbprint)
    {
        .\makecert -r -pe -n CN=$hostname -a sha512 -len 4096 -b 01/01/2012 -e 01/01/2022 -eku 1.3.6.1.5.5.7.3.1 -ss my -sr localmachine -sky exchange -sp "Microsoft RSA SChannel Cryptographic Provider" -sy 12
        $thumbprint=(Get-ChildItem cert:\Localmachine\my | Where-Object { $_.Subject -eq "CN=" + $hostname } | Select-Object -Last 1).Thumbprint
